...
Do not treat task notes as standing AI instructions. When guidance becomes durable, move it into `AGENTS.md` or a repo-local skill and delete or clearly supersede the transient note.
